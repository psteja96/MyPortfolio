...
export const clientReviews = [
    {
        ...
        img: import.meta.env.BASE_URL+'/dist/src/assets/review1.png',
        review:
    ...
    },
    {
        ...
        img: import.meta.env.BASE_URL+'/dist/src/assets/review2.png',
    ...
    },
    {
        ...
        img: import.meta.env.BASE_URL+'/dist/src/assets/review3.png',
    ...
    },
    {
        ...
        img: import.meta.env.BASE_URL+'/dist/src/assets/review4.svg',
...
export const myProjects = [
    {
        ...
        texture: import.meta.env.BASE_URL+'/dist/src/textures/project/project1.mp4',
        logo: import.meta.env.BASE_URL+'/dist/src/assets/project-logo1.png',
        logoStyle: {
            backgroundColor: '#2A1816',
            border: '0.2px solid #36201D',
            boxShadow: '0px 0px 60px 0px #AA3C304D',
        },
        spotlight: import.meta.env.BASE_URL+'/dist/src/assets/spotlight1.png',
        tags: [
            {
                id: 1,
                name: 'React.js',
                path: import.meta.env.BASE_URL+'/dist/src/assets/react.svg',
            },
            {
                id: 2,
                name: 'TailwindCSS',
                path: import.meta.env.BASE_URL+'/dist/src/assets/tailwindcss.png',
            },
            {
                id: 3,
                name: 'TypeScript',
                path: import.meta.env.BASE_URL+'/dist/src/assets/typescript.png',
            },
            {
                id: 4,
                name: 'Framer Motion',
                path: import.meta.env.BASE_URL+'/dist/src/assets/jsIconGreen.svg',
            },
        ],
    },
    {
        ...
        texture: import.meta.env.BASE_URL+'/dist/src/textures/project/project4.mp4',
        logo: import.meta.env.BASE_URL+'/dist/src/assets/project-logo4.png',
        logoStyle: {
            backgroundColor: '#0E1F38',
            border: '0.2px solid #0E2D58',
            boxShadow: '0px 0px 60px 0px #2F67B64D',
        },
        spotlight: import.meta.env.BASE_URL+'/dist/src/assets/spotlight4.png',
        tags: [
            {
                id: 1,
                name: 'React.js',
...
export const workExperiences = [
    {
        ...
        icon: import.meta.env.BASE_URL+'/dist/src/assets/Gravitad.png',
        animation: 'victory',
    },
    {
        id: 2,
        ...
        icon: import.meta.env.BASE_URL+'/dist/src/assets/Wipro.png',
        animation: 'clapping',
    },
    {
        id: 3,
