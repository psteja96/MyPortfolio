...
const DemoComputer = (props) => {
    const group = useRef();
    const { nodes, materials } = useGLTF(import.meta.env.BASE_URL+'/src/models/computer.glb')

    const txt=useVideoTexture(props.texture?props.texture:import.meta.env.BASE_URL+"/src/textures/project/project1.mp4");
   useGSAP(()=>{
...
useGLTF.preload(import.meta.env.BASE_URL+'/src/models/computer.glb');
