            ...
            <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
                <div className="col-span-1 xl:row-span-3">
                    <div className="grid-container">
                        <img src={import.meta.env.BASE_URL+"/dist/src/assets/grid1.png"} alt="grid1" className="w-full sm:h-[276px] h-fit object-contain"/>
                        <div>
                ...
                <div className="col-span-1 xl:row-span-3">
                    <div className="grid-container">
                        <img src={import.meta.env.BASE_URL+"/dist/src/assets/grid2.png"} alt="grid-2" className="w-full sm:w-[276px] h-fit object-contain"/>
                ...
                <div className="xl:col-span-2 xl:row-span-3">
                    <div className="grid-container">
                        <img src={import.meta.env.BASE_URL+"/dist/src/assets/grid3.png"} alt="grid3" className="w-full sm:h-[276px] h-fit object-contain"/>
                        <div>
                            <p className="grid-headtext">
                ...
                <div className="xl:col-span-1 xl:row-span-2">
                    <div className="grid-container">
                        <img src={import.meta.env.BASE_URL+"/dist/src/assets/grid4.png"} alt="grid4" className="w-full md:h-[176px] sm:h-[276px] h-fit object-cover sm:object-top"/>
                        <div className="space-y-2">
                            <p className="grid-headtext text-center">
                                Contact Me
                            </p>
                            <div className="copy-container" onClick={handleCopy}>
                                <img src={hasCopied?import.meta.env.BASE_URL+'/dist/src/assets/tick.svg':import.meta.env.BASE_URL+'/dist/src/assets/copy.svg'} alt="copy icon"/>
